...
export const kendraIndexName = 'itops-opsgenie-kendra-index'
// must be unique globally or the deployment will fail
// export const cognitoDomainName = "itops-hhs-chatbot"
export const cognitoDomainName = "itops-opsgenie-hhs-chatbot"
...
export const stackName = "ITOPSOpsGenieRAGStack"
